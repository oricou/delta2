...
from ndf_naissance_deces import naissance_deces as ndf_lib
             ...
             children=[ 
                 ...
                 html.Div(className="two columns",
                          children = [
                              ...
                              html.Br(),
                              dcc.Link(html.Button('Naissance et Décès', style={'width':"100%"}), href='/ndf'),
                              html.Br(),
                              html.Br(),
                              html.Br(),
